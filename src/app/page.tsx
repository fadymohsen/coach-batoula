  ...
  return (
    <div className="flex flex-col min-h-screen bg-background selection:bg-rose/30">
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener"
        className="pulse-ring fixed bottom-8 left-6 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl shadow-green-500/30"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-12">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="flex flex-col items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-11 h-11 rounded-full glass-dark flex items-center justify-center hover:bg-rose/30 transition-colors">
