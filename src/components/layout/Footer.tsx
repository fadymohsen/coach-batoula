      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-12">
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.instagram.com/batool.home?igsh=MXhnY3R5eDh0d20wcQ==" target="_blank" rel="noopener" aria-label="إنستغرام" className="w-11 h-11 rounded-full glass-dark flex items-center justify-center hover:bg-rose/30 transition-colors">
            ...
            <a href="https://www.facebook.com/share/1HAy8RGqgV/" target="_blank" rel="noopener" aria-label="فيسبوك" className="w-11 h-11 rounded-full glass-dark flex items-center justify-center hover:bg-rose/30 transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.tiktok.com/@batool_home?_r=1&_t=ZN-95w9fa2xqyZ" target="_blank" rel="noopener" aria-label="تيك توك" className="w-11 h-11 rounded-full glass-dark flex items-center justify-center hover:bg-rose/30 transition-colors">
            ...
            <a href="https://youtube.com/@batoolhome6303?si=1u2ZLkH4PhLCTd30" target="_blank" rel="noopener" aria-label="يوتيوب" className="w-11 h-11 rounded-full glass-dark flex items-center justify-center hover:bg-rose/30 transition-colors">
